  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="w-[70%] justify-between sm:flex sm:flex-col md:flex md:flex-row">
          <div>
            <h3 className="text-xl font-bold mb-4">Latinx Testing Solutions</h3>
            <p className="text-gray-400">
              Improving cognitive assessments for Latinx <br /> populations through research-based resources.
            </p>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold mb-4 mt-[60px] md:mt-0 ">Quick Links</h4>
            <ul className="space-y-2">
              <li><Link to="/" className='text-gray-400 hover:text-white'>About</Link></li>
              <li><Link to="/tool" className='text-gray-400 hover:text-white'>Clinical Guide Tool</Link></li>
